...
export default function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>The Design Elves | Contact</title>
        <meta name="description" content="Let’s build something great. Tell us about your project — we'll get back within 24 hours." />
      </Helmet>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.container}>
          <div className={`${styles.header} fade-up`}>
            <h1 className={styles.title}>Let’s build<br />something great.</h1>
            <p className={styles.subtitle}>Tell us about your project — we’ll get back within 24 hours.</p>
          </div>

          <div className={`${styles.info} fade-up stagger-1`}>
            <div className={styles.block}>
              <span className={styles.label}>EMAIL US</span>
              <a href="mailto:thedesignelves@gmail.com" className={styles.text}>thedesignelves@gmail.com</a>
            </div>
            <div className={styles.block}>
              <span className={styles.label}>CALL US</span>
              <a href="tel:+919098111911" className={styles.text}>+91 9098111911</a>
            </div>
            <div className={styles.block}>
              <span className={styles.label}>LOCATION</span>
              <p className={styles.text}>Pune, Maharashtra<br />India</p>
            </div>
            <div className={styles.block}>
              <span className={styles.label}>FOLLOW US</span>
              <div className={styles.socials}>
                <a className={styles.social} target="_blank" rel="noopener noreferrer" aria-label="Instagram" href="https://www.instagram.com/the_design_elves?igsh=MWViMXo4Mnl3MWM3cw==">
                ...
                <a className={styles.social} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" href="https://www.linkedin.com/company/the-design-elves/?viewAsMember=true">
                ...
                <a className={styles.social} target="_blank" rel="noopener noreferrer" aria-label="Behance" href="https://www.behance.net/waddleco">
